  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangpinpingfen" label="商品评分" prop="shangpinpingfen">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fuwupingfen" label="服务评分" prop="fuwupingfen">
              <el-input v-model="ruleForm.fuwupingfen" 
                placeholder="服务评分" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="物流评分" prop="wuliupingfen">
          <el-select v-model="ruleForm.wuliupingfen" placeholder="请选择物流评分">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wuliupingfen" label="物流评分" prop="wuliupingfen">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.beizhu" label="备注" prop="beizhu">
              <el-input v-model="ruleForm.beizhu" 
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                        ...
                                        this.wuliupingfenOptions = "1,2,3,4,5".split(',')
                                                                                                                                        },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
