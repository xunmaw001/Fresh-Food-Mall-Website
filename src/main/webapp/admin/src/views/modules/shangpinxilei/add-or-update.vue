<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="细类" prop="xilei">
          <el-input v-model="ruleForm.xilei" 
              placeholder="细类" clearable></el-input>
        </el-form-item>
        <div v-else>
...
export default {
      ...
      type: '',
            ruleForm: {
                        xilei: '',
                          ...
                          rules: {
                  xilei: [
                            { required: true, message: '细类不能为空', trigger: 'blur' },
                                                                                              ],
              }
    };
  },
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shangpinxilei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangpinxileiCrossAddOrUpdateFlag = false;
                  this.parent.search();
