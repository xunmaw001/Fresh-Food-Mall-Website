  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.leixing" label="类型" prop="leixing">
          ...
          <el-form-item class="input" v-if="ruleForm.fenlei" label="分类" prop="fenlei">
              <el-input v-model="ruleForm.fenlei" 
                placeholder="分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="细类" prop="xilei">
          <el-select v-model="ruleForm.xilei" placeholder="请选择细类">
            <el-option
                v-for="(item,index) in xileiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xilei" label="细类" prop="xilei">
              <el-input v-model="ruleForm.xilei" 
                placeholder="细类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chandi" label="产地" prop="chandi">
              <el-input v-model="ruleForm.chandi" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.onelimittimes" label="单限" prop="onelimittimes">
              <el-input v-model="ruleForm.onelimittimes" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.alllimittimes" label="库存" prop="alllimittimes">
              <el-input v-model="ruleForm.alllimittimes" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhekoushangpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhekoushangpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
